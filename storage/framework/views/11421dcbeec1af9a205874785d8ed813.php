                    ...
                    <div class="content">
                      <div class="row ">
                          <div class="container-fluid" id="addBn">
                                    ...
                                    <a href="<?php echo e(url('/violation_entry/create')); ?>"  class="btn btn-primary" >
                                    ...
                                    <thead class="thead-dark">
                                      <tr>
                                        ...
                                        <th scope="col-4">Action</th>
                                          ...
                                          <tbody>
                                            <?php $__currentLoopData = $v; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <tr>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\Projects\web_projects\Violation_website\violationApp3\resources\views/violation_entry/index.blade.php ENDPATH**/ ?>